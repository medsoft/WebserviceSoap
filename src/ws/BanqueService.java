...
public interface BanqueService {
    ...
    @RequestWrapper(localName = "conversionEuroTeFR", targetNamespace = "http://ws/", className = "ws.ConversionEuroTeFR")
    @ResponseWrapper(localName = "conversionEuroTeFRResponse", targetNamespace = "http://ws/", className = "ws.ConversionEuroTeFRResponse")
    @Action(input = "http://ws/BanqueService/conversionEuroTeFRRequest", output = "http://ws/BanqueService/conversionEuroTeFRResponse")
    public double conversionEuroTeFR(
